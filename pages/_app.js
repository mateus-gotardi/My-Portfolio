...
function MyApp({ Component, pageProps }) {
  ...
  const englishTexts = {
    ...
    about2: "For me, technology is more than just a field of study or work. It's a passion that drives and inspires me every day. I'm always seeking to learn more about the latest trends in web development and explore new technologies that can change the way we see the world.",
    about3: "I believe that technology has the power to transform the world, and I want to be part of that movement. Whether it's creating websites and apps that make people's lives easier, or developing innovative solutions that solve complex problems, I'm always looking for ways to use technology to make a difference.",
    about4: "If you're looking for a technology-loving professional who is dedicated to creating innovative solutions, don't hesitate to contact me. Let's transform the world with technology together!",
  ...
  const portugueseTexts = {
    ...
    about2: 'Para mim, a tecnologia é mais do que apenas um campo de estudo ou trabalho. É uma paixão que me move e me inspira a cada dia. Estou sempre buscando aprender mais sobre as últimas tendências em desenvolvimento web e explorar novas tecnologias que possam mudar a maneira como vemos o mundo.',
    about3: 'Acredito que a tecnologia tem o poder de transformar o mundo e quero fazer parte desse movimento. Seja criando sites e aplicativos que facilitem a vida das pessoas, ou desenvolvendo soluções inovadoras que resolvam problemas complexos, eu estou sempre buscando maneiras de usar a tecnologia para fazer a diferença.',
    about4: 'Se você está procurando um profissional apaixonado por tecnologia e dedicado a criar soluções inovadoras, não hesite em me contatar. Vamos juntos transformar o mundo com tecnologia!',
